...
#include "../PortScanner/mythread.h"
...
QT_MOC_LITERAL(5, 27, 4), // "port"
QT_MOC_LITERAL(6, 32, 6), // "isOpen"
QT_MOC_LITERAL(7, 39, 6), // "finish"
QT_MOC_LITERAL(8, 46, 9), // "MyThread*"
QT_MOC_LITERAL(9, 56, 1) // "p"

    },
    "MyThread\0done\0\0QString*\0ip\0port\0isOpen\0"
    "finish\0MyThread*\0p"
};
...
void MyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->done((*reinterpret_cast< QString*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< bool(*)>(_a[3]))); break;
        case 1: _t->finish((*reinterpret_cast< MyThread*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (MyThread::*_t)(QString * , int , bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyThread::done)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (MyThread::*_t)(MyThread * );
...
// SIGNAL 0
void MyThread::done(QString * _t1, int _t2, bool _t3)
{
...
// SIGNAL 1
void MyThread::finish(MyThread * _t1)
{
